...
;;<< Drawing 5/8
;;<< Big Bang 6/8
;;<< Game Ending on Overflow 5/8

;;<< Correctly rotate individual tetras
;;<< Correctly move individual tetras down
;;<< Correctly detect when tetras can't move down
;;<< Correctly construct new tetra and modify world set on collision
;;<< individual blocks should be seperated by lines -1
;;<< DESIGN RECIPE -2 PER SECTION
;;<< no tests or signatures provided
;;<< Game should end rather than restart -1
;;<< functionally correct but minimal usage of the design recipe
